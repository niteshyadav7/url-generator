      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl border border-slate-800/40 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="font-bold text-2xl tracking-tight bg-gradient-to-r from-white via-indigo-100 to-slate-400 bg-clip-text text-transparent">
            Welcome to AmzLinker
          </h2>
          <p className="text-slate-400 text-xs mt-1">Generate optimized Amazon associate links instantly</p>
        </div>

        {error && (
          <div className="mb-6 p-4 rounded-xl bg-rose-500/10 border border-rose-500/25 text-rose-400 text-sm font-medium animate-pulse">
            {error}
          </div>
        )}
